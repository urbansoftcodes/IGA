...
public partial class VideoGallery : System.Web.UI.Page
{
    ...
    static string tid = System.Configuration.ConfigurationSettings.AppSettings["video"].ToString().Trim();
    ...
    public void LoadProducts()
    {
        ...
        dlProducts.DataBind();
        dlProducts1.DataSource = ds;
        dlProducts1.DataBind();
    }
            ...
            case "L1":
                ...
                else
                {
                    if (dtca.Rows.Count > 0)
                    {
                        ...
                        lblProducts2.Text = dtca.Rows[0]["CategoryName"].ToString().Trim();
                    }
    ...
    protected void dlProducts_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
           ...
           e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            HtmlControl hc = (HtmlControl)e.Item.FindControl("vidframe");
            HtmlControl hc1 = (HtmlControl)e.Item.FindControl("vidvid");

            Label lbvurl = (Label)e.Item.FindControl("lblvurl");

            string fe = Path.GetExtension(lbvurl.Text.ToString().Trim());
