...
public partial class PhotoGallery : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["pgallery"] != null)
            {
                //lblpid.Text = Request.QueryString["c"].ToString().Trim();
                lblpid.Text = Session["pgallery"].ToString().Trim();
            }
            LoadCategory();
            LoadLang();
            LoadProducts();
            ...
            case "L2":
                ...
                if (a=="")
                {
                    if (dtca1.Rows.Count > 0)
                    {
                        ...
                        lblProducts3.Text = dtca1.Rows[0]["TypesName1"].ToString().Trim();
                    }
                ...
                else
                {
                    if(dtca.Rows.Count>0)
                    {
                        ...
                        lblProducts3.Text = dtca.Rows[0]["CategoryName1"].ToString().Trim();
                    }
            ...
            case "L1":
                ...
                if (a == "")
                {
                    if (dtca1.Rows.Count > 0)
                    {
                        ...
                        lblProducts3.Text = dtca1.Rows[0]["TypesName"].ToString().Trim();
                    }
                }
                else
                {
                    if (dtca.Rows.Count > 0)
                    {
                        ...
                        lblProducts2.Text = dtca.Rows[0]["CategoryName1"].ToString().Trim();
                        lblProducts3.Text = dtca.Rows[0]["CategoryName"].ToString().Trim();
                    }
