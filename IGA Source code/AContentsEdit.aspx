<%@ Page Title="" Language="C#" MasterPageFile="~/amain.master" AutoEventWireup="true" CodeFile="AContentsEdit.aspx.cs" Inherits="AContentsEdit" %>
                    ...
                    <%-- tab 1--%>
                                             ...
                                             <div class="form-group col-lg-3" style="display:none;">
                                                       ...
                                                       <div class="row"> 
                                                        ...
                                                        <div class="form-group col-lg-3">
                                                        <label class="control-label col-xs-12 no-padding-right required" for="email">Order for Speakers:</label>
                                                        <div class="col-xs-12 col-sm-10">
                                                            <div class="clearfix">
                                                               <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control" ></asp:TextBox>
                                                                <asp:Label ID="lblPrice" runat="server" Text="" ForeColor="Maroon"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <asp:ListItem>Closed</asp:ListItem>
                                                        ...
                                                        <label class="control-label col-xs-12 no-padding-right required" for="email">Content Type</label>
                                                        <div class="col-xs-12 col-sm-10">
                                                            <div class="clearfix">
                                                               <asp:RadioButtonList ID="rbtnCType" CssClass="radio1" Width="100%"  runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Selected="True">Content</asp:ListItem>
                                                <asp:ListItem>Document</asp:ListItem>
                                            </asp:RadioButtonList>
                                                                <asp:Label ID="lblCType" runat="server" Text="" ForeColor="Maroon"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                             ...
                                                             <div class="form-group col-lg-4" style="display:none;">
                                                        <label class="control-label col-xs-12 no-padding-right required" for="email">Home Page Slide</label>
                                                        <div class="col-xs-12 col-sm-10">
                                                            <div class="clearfix">
                                                               <asp:RadioButtonList ID="rbtnSetting" CssClass="radio1" Width="100%"  runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem>Yes</asp:ListItem>
                                                <asp:ListItem Selected="True">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                                                <asp:Label ID="Label4" runat="server" Text="" ForeColor="Maroon"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row" style="display:none;"> 
                                                             <div class="form-group col-lg-3">
                                                        <label class="control-label col-xs-12 no-padding-right required" for="email">Setting 2</label>
                                                        <div class="col-xs-12 col-sm-10">
                                                            <div class="clearfix">
                                                               <asp:RadioButtonList ID="rbtnSetting1" CssClass="radio1" Width="100%"  runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem>Yes</asp:ListItem>
                                                <asp:ListItem Selected="True">No</asp:ListItem>
                                            </asp:RadioButtonList>
                                                                <asp:Label ID="Label6" runat="server" Text="" ForeColor="Maroon"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            </div>
                        ...
                        <div class="row"> 
                                                        ...
                                                        <div class="col-xs-12 col-sm-10">
                                                            <div class="clearfix">
                                                                ...
                                                                <asp:Label ID="Label2" runat="server" Text="Image / File" ForeColor="Maroon"></asp:Label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        <div class="form-group col-lg-3">
											     		...
											     		<div class="col-xs-12 col-sm-10">
																	<div class="clearfix">
                                                                        ...
                                                                        <asp:Label ID="Label3" runat="server" Text="" ForeColor="Maroon"></asp:Label>
																	</div>
																</div>
															</div>   
